export default function ProjectThree() {
  return (
    <div className="w-full text-center space-x-8 h-full flex flex-row text-start items-center justify-center opacity-50 transition-all ease-in-out  sm:space-x-0 sm:opacity-100">
      <div className="w-full h-full flex flex-row justify-center items-center transition-all hover:opacity-100 sm:flex-col">
